        ...
        id="Desc2"
            ...
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                ...
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    <div id="Desc2Text" className="p-6 rounded-2xl">
                    ...
                    <div aria-hidden="true" className="mt-10 lg:mt-0">
                        <img 
                            src="https://raw.githubusercontent.com/prazzdev/porttest/main/src/assets/image/desc1.webp" 
                            alt="" 
                            className="mx-auto rounded-lg shadow-lg dark:bg-gray-500 object-cover" />
                    </div>
                </div>
                <div id="Desc2Text">
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        <div className="lg:col-start-2 p-6 rounded-2xl">
                        ...
                        <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                            <img 
                                src="https://raw.githubusercontent.com/prazzdev/porttest/main/src/assets/image/desc4.webp" 
                                alt="" 
